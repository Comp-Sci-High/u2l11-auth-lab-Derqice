...
let key= "l1dWacVQSx1a2LVG77isnqc8RlNhTsPz"
...
let body= "api.giphy.com/v1/gifs/search"
...
let requestURL= "https://"+body+"?q=raccoon&limit=1&api_key="+key
...
let requestURL2= "https://api.giphy.com/v1/stickers/random?api_key="+key

// Define and call the function that prints just the sticker URL
async function fetchers(url){
let response= await fetch(url)
let data= await response.json()
console.log(data.data.url)
return(data)
}
fetchers(requestURL2)
